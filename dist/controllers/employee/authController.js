...
const authService_1 = require("../../services/employee/authService");
...
class AuthController {
   ...
   * @param res
   */
    employeeResetPassword(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const responseFromService = yield authService.resetPassword(req.body, req.user);
                appUtils.successResponse(res, responseFromService, constants.MESSAGES.reset_pass_success);
   ...
   */
    getMyProfile(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const responseFromService = yield authService.getMyProfile(req.user);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (responseFromService) {
                    userData = yield authService.getMyProfile(req.user);
                }
