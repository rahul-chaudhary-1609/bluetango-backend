...
const staticContent = new index_1.StaticContentService();
class StaticContentController {
     ...
     * @param res
     */
    addStaticContent(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const responseFromService = yield staticContent.addStaticContent(req.body, req.user);
    ...
    getStaticContent(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const responseFromService = yield staticContent.getStaticContent(req.query);
